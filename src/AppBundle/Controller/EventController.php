...
class EventController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()){
            ...
            return $this->redirect($this->generateUrl('api_event_show', array('id' => $entity->getId())));
        }
     ...
     *
     * @Route("/{id}/edit", name="api_event_edit")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="api_event_update")
     * @Method("PUT")
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()){
            ...
            return $this->redirect($this->generateUrl('api_event_edit', array('id' => $id)));
        }
     ...
     *
     * @Route("/{id}", name="api_event_delete")
     * @Method("DELETE")
     */
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('api_event'));
    }
}
